...
YT_video = "kv_97RYh1PY&list=RDkv_97RYh1PY&start_radio=1"  # Change this to an empty string or provide a default video ID
...
YT_video = st.text_input("YouTube Video ID (e.g., 1egAKCKPKCk?t=2743)", YT_video)
